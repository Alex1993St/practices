...
class ElasticSearchService
{
     ...
     * Ствоерння індексу
     */
    public function createIndex($index = 'my_index')
    {
        $params = [
            'index' => $index
        ];
     ...
     * Додавання документу
     */
    public function addDocument($index = 'my_index', $body)
    {
        $params = [
            'index' => $index,
            'body' => $body
     ...
     */
    public function massAddDocument($index = 'my_index')
    {
        $params = ['body' => []];
     ...
     */
    public function getDocument($index = 'my_index')
    {
        $params = [
            'index' => $index,
            'id' => '1'
     ...
     */
    public function getInfo($index = 'my_index')
    {
        $params = [
            'index' => $index,
     ...
     */
    public function getFirstIndex($index = 'my_index')
    {
     ...
     * \ Видалити індекс
     */
    public function removeIndex($index = 'my_index')
    {
     ...
     *  Видалити документ
     */
    public function removeDocument($index = 'my_index', $id)
    {
     ...
     *  хз в мене додлало
     */
    public function update($index = 'my_index')
    {
     ...
     */
    public function findShardByDoc($index = 'my_index')
    {
     ...
     */
    public function getSearch($index = 'my_index')
    {
        return $this->client->search([
            'index' => $index,
            'body' => [
...
//                    ]
    ...
    public function getAll($index = 'my_index')
    {
        $search_params = [
            'scroll' => '5m', // period to retain the search context
            'index' => $index, // here the index name
        ...
        $pages = new SearchResponseIterator($this->client, $search_params);
        $hits = new SearchHitIterator($pages);

        $data = [];
        foreach ($hits as $key => $hit) {
            $data[$key] = $hit['_source'];
            $data[$key]['id'] = $hit['_id'];
